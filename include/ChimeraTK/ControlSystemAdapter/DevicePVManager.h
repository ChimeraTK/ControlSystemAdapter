...
public:
  ...
  typename ProcessArray<T>::SharedPtr createProcessArray(
      ...
      const std::string &description = "", T initialValue = T(),
  ...
  getProcessArray(const ChimeraTK::RegisterPath &processVariableName) const;
  ...
  getProcessVariable(const ChimeraTK::RegisterPath &processVariableName) const;
...
typename ProcessArray<T>::SharedPtr DevicePVManager::createProcessArray(
  ...
  case bidirectional:
    ...
    return _pvManager
        ->createBidirectionalProcessArray<T>(processVariableName,
                                             std::vector<T>(size, initialValue),
                                             unit, description, numberOfBuffers)
        .second;
  default:
...
typename ProcessArray<T>::SharedPtr DevicePVManager::createProcessArray(
  ...
  case bidirectional:
    ...
    return _pvManager
        ->createBidirectionalProcessArray<T>(processVariableName, initialValue,
                                             unit, description, numberOfBuffers)
        .second;
  default:
    throw ChimeraTK::logic_error("invalid SynchronizationDirection");
