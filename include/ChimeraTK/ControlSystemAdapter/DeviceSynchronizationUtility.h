...
namespace ChimeraTK {
  ...
  public:
    ...
    */
     ...
     * registered with
     * {@link #addReceiveNotificationListener(ChimeraTK::RegisterPath const &, ProcessVariableListener::SharedPtr)}.
  ...
  private:
    ...
    DeviceSynchronizationUtility & operator=(
        DeviceSynchronizationUtility const &);
  };
