...
namespace ChimeraTK {
  ...
  DeviceSynchronizationUtility::DeviceSynchronizationUtility(DevicePVManager::SharedPtr pvManager)
  ...
  void DeviceSynchronizationUtility::addReceiveNotificationListener(ChimeraTK::RegisterPath const& processVariableName,
  ...
  void DeviceSynchronizationUtility::addReceiveNotificationListener(ProcessVariable::SharedPtr const& processVariable,
      ProcessVariableListener::SharedPtr receiveNotificationListener) {
    _receiveNotificationListeners.erase(processVariable.get());
  ...
  void DeviceSynchronizationUtility::waitForNotifications(long timeoutInMicroseconds,
